...
#include "jenkinsBuildEngine.hh"
#include "jenkinsBuildParser.hh"

JenkinsBuildEngine::JenkinsBuildEngine() :
    m_reader(new QXmlSimpleReader()),
    m_source(NULL)
{
    JenkinsBuildParser *parser = new JenkinsBuildParser();
...
bool JenkinsBuildEngine::parse(QIODevice *input)
{
    bool ret;
...
void JenkinsBuildEngine::parseContinue()
{
